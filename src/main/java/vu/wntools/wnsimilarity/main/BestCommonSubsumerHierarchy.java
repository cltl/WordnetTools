 ...
 */
public class BestCommonSubsumerHierarchy {
...
*/
    ...
    public static void getMostCommonWordSubsumer (WordnetData wordnetData, ArrayList<WordData> wordMap, FileOutputStream fos) {
        try {
            HashMap<String, ArrayList<ArrayList<String>>> wordHyperMap = new HashMap<String, ArrayList<ArrayList<String>>>();
            String keystr = "";
            HashMap <String, SynsetNode> hyperTree = new HashMap<String, SynsetNode>();

            /// WE FIRST BUILD A HYPERTREE BASED ON ALL MEANING OF A WORD AND WE PASS ON THE FREQUENCIES FROM THE LEAVES TO THE HYPERNYMS
            ...
            /**
             * Next we select those chains that have the most frequent most specific hypernym
