...
public class CatToConll {
    ...
    static public void main (String[] args) {
        ...
        pathToTextFile = "/Users/piek/" +
                "Desktop/MasterLanguage/CAT_XML_std-off_export_2015-05-11_22_31_46/hobbit.txt.xml";
        String labeledText = "";
        CatParser catParser = new CatParser("ANNOTATION");
        catParser.relationnName = "COHERENCE";
        catParser.parseFile(pathToTextFile);
        labeledText += "Tokenid\tWord"+catParser.attributeListToString()+"\t"+"COHERENCE\n";
